<template>
  ...
  <div class="col-sm-3 p-0 collapse navbar-collapse d-sm-block" id="mySidebar" style="z-index:9999;">
    <div class="w-100 sidenav col-sm-3 p-0">
      ...
      <div class="w-100 p-3">
        <router-link to="/dashboard" class="side-link"><i class="fa fa-home"></i> Dashboard</router-link>
        <router-link to="/wallet" class="side-link"><i class="fa fa-money"></i> Wallet</router-link>
        <router-link to="/orders" class="side-link"><i class="fa fa-list"></i> My orders</router-link>
      </div>
      <div class="w-100 p-3 bottom-link  text-center">
        <button @click="userLogout()" class="btn btn-link text-danger btn-block p-2">Logout</button>
      </div>
    </div>
  </div>
</template>
